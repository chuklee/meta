...
class Neurone:
    ...
    def __init__(self, username, password, pt_vote = 0, pt_confiance = 3):
        ...
        self.valeur = 0 #Compte du neurone (combien d'argent il détient dans la base). Ici il faudrat vérifier que l'argent reste bien dans le neurone et qu'il puisse pas faire de magouille.
        self.rendement = 0 #Formule à détermier en fonction du gain par rapport à l'argent investit et le temps depuis lequel il investit.
